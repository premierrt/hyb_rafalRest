...
import org.training.constants.RafalRest1Constants;



/**
 * This is the extension manager of the RafalRest1 extension.
 */
public class RafalRest1Manager extends GeneratedRafalRest1Manager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(RafalRest1Manager.class.getName());
	 ...
	 */
	public static RafalRest1Manager getInstance()
	{
		return (RafalRest1Manager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				RafalRest1Constants.EXTENSIONNAME);
	}
	 ...
	 */
	public RafalRest1Manager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of RafalRest1Manager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of RafalRest1Manager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of RafalRest1Manager called, current tenant: " + getTenant().getTenantID());
		}
	}
